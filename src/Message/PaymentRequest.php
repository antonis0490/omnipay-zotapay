...
{
    public $liveEndpoint = 'https://api.zotapay.com/api/v2/prv/';
    public $liveEndpoint2 = 'https://bill.zotapay.com/order/external/main.action';
    ...
    public function sendData($data)
    {
        ...
        if ($this->getHttpMethod() == 'GET') {
            ...
            $httpRequest = $this->httpClient->createRequest(
                $this->getHttpMethod(),
                $this->getEndpoint().$this->getzotapayWallet()."/bills/".$this->getComment(),
                array(
                    'Accept' => 'application/json'
                ),
        ...
        try {
            ...
            $httpRequest->setAuth($this->getzotapayApiId(), $this->getzotapayApiPass());
